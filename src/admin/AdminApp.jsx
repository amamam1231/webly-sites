      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
        <div className="max-w-md w-full bg-white p-8 rounded-xl shadow-lg border border-gray-100">
          ...
          <p className="text-center text-gray-600 text-sm mb-6">
            {isSetupState ? (
              <>
                <strong>Первый вход:</strong> используйте ваш Telegram ID<br/>
                как логин и пароль (вы получили его в боте)
              </>
          ...
          <form onSubmit={handleAuth} className="space-y-5">
            <div>
              ...
              <input 
                ...
                placeholder={isSetupState ? "Ваш Telegram ID" : ""}
            ...
            <div>
              ...
              <input 
                ...
                placeholder={isSetupState ? "Ваш Telegram ID (тот же)" : ""}
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none text-gray-900"
                required
              />
            </div>
          ...
          {/* Forgot Password Modal - вынесен сюда чтобы работал после logout */}
          {showForgotPassword && (
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
              <div className="bg-white rounded-xl shadow-2xl max-w-md w-full p-8">
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Забыли пароль?</h3>
                <p className="text-gray-600 mb-6">
                  Для безопасного сброса пароля обратитесь к боту Webly AI в Telegram.
                </p>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                  ...
                  <ol className="text-sm text-gray-700 space-y-2 list-decimal list-inside">
                    <li>Откройте бота <a href="https://t.me/WeblyAIBot" target="_blank" className="text-blue-600 underline">@WeblyAIBot</a></li>
                    <li>Напишите команду <code className="bg-gray-100 px-2 py-1 rounded">/reset_password</code></li>
                    <li>Бот сбросит ваш пароль на ваш Telegram ID</li>
                    <li>Войдите с новым паролем и создайте уникальный</li>
                  </ol>
                </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col md:flex-row font-sans text-gray-900">
      ...
      {showPasswordModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-2xl max-w-md w-full p-8">
            <h3 className="text-2xl font-bold text-gray-900 mb-2">Создайте безопасный пароль</h3>
            <p className="text-gray-600 mb-6">
              Вы вошли с временным паролем. Пожалуйста, создайте уникальный пароль для защиты вашей админ-панели.
            </p>
