...
// Gold SVG Icon Component - Trapezoid stack design
const GoldIcon = ({ className }) => (
  <svg viewBox="0 0 800 800" className={className} fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path d="M261.5 161h277l178.5 208H83z"/>
    <path d="M122.5 431h555L554 800H246z"/>
    <path d="M431 431h308L616 639H308z"/>
  </svg>
);

// Solana SVG Icon Component - Gradient parallelograms
const SolanaIcon = ({ className }) => (
  <svg viewBox="0 0 400 300" className={className} xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M0 20 L160 20 L180 60 L20 60 Z" fill="url(#solGrad1)"/>
    <path d="M20 120 L180 120 L200 160 L40 160 Z" fill="url(#solGrad2)"/>
    <path d="M10 220 L170 220 L190 260 L30 260 Z" fill="url(#solGrad3)"/>
  </svg>
);
...
const DollarIcon = ({ className }) => (
  <svg viewBox="0 0 100 100" className={className} fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path d="M50 10v80M35 25c0-8.284 6.716-15 15-15s15 6.716 15 15-6.716 15-15 15H35zm0 20h15c8.284 0 15 6.716 15 15s-6.716 15-15 15H35V45z" stroke="currentColor" strokeWidth="8" fill="none" strokeLinecap="round"/>
  </svg>
);

// Layers SVG Icon Component - Three parallelograms
const LayersIcon = ({ className }) => (
  <svg viewBox="0 0 640 480" className={className} fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path d="M167 165h466l-100 150H67z"/>
    <path d="M167 332h466l-100 150H67z"/>
    <path d="M167 499h466l-100 150H67z" opacity="0.7"/>
  </svg>
);
            ...
            <div className="bg-white/5 rounded-lg p-3 md:p-4 space-y-2">
              ...
              <div className="flex justify-between">
                ...
                <button 
                  ...
                  className="w-full py-3.5 md:py-4 bg-[#FF4D00] hover:bg-[#ff6a2b] text-[#050505] rounded-lg font-mono font-bold transition-all transform hover:scale-[1.02] text-sm md:text-base disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isLoading ? 'PROCESSING...' : 'EXECUTE TRANSMUTATION'}
                </button>
              </div>
            </>
          )}
          ...
          {isSuccess && (
            ...
            >
              <motion.div
                ...
                animate={{ scale: 1 }}
                transition={{ type: "spring", bounce: 0.5 }}
                className="w-16 h-16 mx-auto mb-4 rounded-full bg-[#FF4D00]/20 flex items-center justify-center"
              >
                <SafeIcon name="check" size={32} className="text-[#FF4D00]" />
              </motion.div>
              <h3 className="font-serif text-2xl font-bold text-white mb-2">Transmutation Complete!</h3>
              <p className="font-mono text-sm text-[#E5E5E5]/60 mb-6">Your transaction has been processed successfully</p>
              <button
                onClick={handleClose}
                className="px-8 py-3 bg-[#FF4D00] hover:bg-[#ff6a2b] text-[#050505] rounded-lg font-mono font-bold transition-all"
              >
                CLOSE
              </button>
            </motion.div>
        ...
        {features.map((feature, index) => (
          ...
          >
            ...
            <div className="relative z-10 flex-1">
              ...
              <p className="font-mono text-sm text-[#E5E5E5]/70 leading-relaxed mb-6 flex-1">
                {feature.description}
              </p>
            </div>

            <div className="relative z-10 mt-auto opacity-0 group-hover:opacity-100 transition-opacity duration-500">
...
const AlchemicalVault = ({ onTransmuteClick }) => {
  const assets = [
    ...
    { symbol: 'USD', name: 'DOLLAR', fullName: 'USDC Stable', price: '$1.00', change: '+0.01%', icon: 'dollar-sign', isDollar: true },
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="vault-top-line absolute top-0 left-4 right-4 h-1 bg-[#E5E5E5]/20 opacity-60 transition-all duration-500 rounded-full hidden md:block" />
        ...
        {assets.map((asset, index) => (
          ...
          >
            ...
            <div className="relative z-10 flex-1">
              ...
              <h3 className="font-serif text-2xl md:text-3xl font-bold text-white group-hover:text-[#FF4D00] transition-colors mb-6">
                {asset.title}
              </h3>
...
const Pulse = () => {
  ...
  return (
    <div
      ref={containerRef}
      onClick={handleClick}
      className="relative py-32 overflow-visible select-none"
    >
      <div className="absolute inset-0 flex items-center justify-center">
        {[...Array(50)].map((_, i) => (
          <motion.div
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto" style={{ perspective: '1000px' }}>
          {tiers.map((tier, index) => (
            <motion.div
              ...
              className={cn(
                "card-3d relative rounded-2xl p-8 overflow-hidden flex flex-col",
            ...
            >
              ...
              <div className={cn(
                "relative z-10 px-6 py-3 rounded-full mb-6 border-2 flex items-center gap-1 self-start",
              ...
              <ul className="relative z-1 space-y-4 flex-1">
                {tier.features.map((feature, i) => (
    ...
    >
      ...
      >
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.95 }}
          className={cn(
            "px-12 py-6 rounded-full font-mono text-xl font-bold transition-all duration-300 inline-block",
        ...
        <div className={cn(
          ...
          <p>© 2026 AETHER PROTOCOL. All rights reserved.</p>
          <p className="mt-2 text-xs">Liquid Chrome Alchemy • High-End Brutalism</p>
          <p className="mt-2 text-xs">Made with <a href="https://t.me/weblyaibot?start=ref_347995964" target="_blank" rel="noopener noreferrer" className="hover:text-[#FF4D00] transition-colors underline">Webly AI</a></p>
        </div>
      </motion.div>
